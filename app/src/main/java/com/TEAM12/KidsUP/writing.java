    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<filemodel> options =
                new FirebaseRecyclerOptions.Builder<filemodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("myvideos").orderByChild("category").equalTo("Writing"), filemodel.class)
                        .build();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId())
        {
            case R.id.logout: FirebaseAuth.getInstance().signOut();
                startActivity(new Intent(writing.this,MainActivity.class));
                finish();
                break;

            case R.id.manage_profile:startActivity(new Intent(writing.this,update_profile.class));
                break;
        }
